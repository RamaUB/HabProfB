                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="sub_category_id"><?php echo get_phrase('competency'); ?><span class="required">*</span></label>
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="sub_category_id" id="sub_category_id" required>
                                                            <option value=""><?php echo get_phrase('select_a_competency'); ?></option>
                                            ...
                                            <!-- 
                                                <div class="form-group row mb-3">
                                            <label class="col-md-2 col-form-label" for="sub_category_id"><?php echo get_phrase('competency'); ?><span class="required">*</span></label><br>
                                                <div class="col-md-10">
                                                    <?php foreach ($categories->result_array() as $category): ?>
                                                        <label for="<?php echo $category['name']; ?>"><?php echo $category['name']; ?></label>
                                                        <?php $sub_categories = $this->crud_model->get_sub_categories($category['id']);
                                                        foreach ($sub_categories as $sub_category): ?>    
                                                        <input type="checkbox" id="<?php echo $sub_category['id'];?>" name="<?php echo $sub_category['name']; ?>" value="<?php echo $sub_category['name']; ?>">
                                                    <label for="<?php echo $sub_category['id']; ?>"> <?php echo $sub_category['name']; ?></label><br>
                                                    
                                                        <?php endforeach; ?>
                                                        <?php endforeach; ?>
                                                    <?php echo(print_r($sub_category['name'])) ?>
                                                </div>
                                            </div>
                                                        -->
