                    ...
                    <div id="collapseFilter" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body pt-0">
                            <div class="filter_type">
                                <h6><?php echo get_phrase('competencies'); ?></h6>
                                <ul>
                                    <span class="parent-category"><?php echo get_phrase('all_competencies'); ?></span>
                                    <li class="ml-2">
                                        <div class="">
                                            ...
                                            <label for="category_all"><?php echo get_phrase('all_competencies'); ?></label>
                                        </div>
                                    </li>
                                    <?php
                                    $counter = 1;
